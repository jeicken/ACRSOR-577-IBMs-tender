...
- [ ] T010 Define compliance checklist mapped to tender constraints and evidence files
- [ ] T011 [P] Define data classification and confidentiality handling rules
- [ ] T012 [P] Define artifact traceability structure (source link + verification date)
...
- [ ] T021 [US1] Add source traceability metadata for all user-facing outputs
...
- [ ] TXXX Run compliance checklist and capture approvals
- [ ] TXXX [P] Validate final package manifest and reproducible build steps
